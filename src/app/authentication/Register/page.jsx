...
export default function RegistrationForm() {
  ...
  const validate = () => {
    ...
    if (!form.agencyEmail.trim()) e.agencyEmail = "Agency email is required.";
      ...
      e.agencyEmail = "Enter a valid email.";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6 relative">
      ...
      <div className="max-w-4xl w-full bg-white rounded-2xl border border-solid border-[#e3e3e3] p-6 md:p-10">
        ...
        <p className="text-sm text-gray-500 mb-6">
          Fill in agency details and account credentials.
        </p>
        ...
        >
          ...
          <div>
            ...
            />
            {errors.agencyEmail && (
              <p className="text-xs text-red-500 mt-1">{errors.agencyEmail}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.agencyPhone && (
              <p className="text-xs text-red-500 mt-1">{errors.agencyPhone}</p>
            )}
          </div>
